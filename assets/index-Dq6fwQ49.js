...
<body>
  ...
  URL.revokeObjectURL(q);
    ...
    theory: `Практичне заняття спрямоване на формування первинного наукового каркасу дисертаційного дослідження у сфері архітектури та містобудування. Основна увага приділяється формулюванню наукової проблеми та побудові логічної структури дослідження, що охоплює визначення дослідницького питання, об’єкта, предмета, гіпотези, завдань і доказової бази. Аспіранти вчаться відрізняти опис теми від дослідницької постановки, визначати перевірюваний зв’язок між просторовими, функціональними, морфологічними, соціально-поведінковими, історико-культурними, екологічними, параметричними або іншими характеристиками архітектурно-містобудівного середовища. Результатом заняття є не завершений вступ до дисертації, а робоча структура дослідження, яку можна уточнювати під час наступних практичних занять.`,
    totalFields: 11,
    exercises: [
      {
        id: "topic1-ex1",
...
...`
  ...
  {
    id: "topic1-check-1",
    label: "Розумію логіку переходу від загального задуму до початкової структури наукового дослідження"
  },
  {
    id: "topic1-check-2",
    label: "Можу обґрунтувати, яку саме наукову проблему досліджує моя тема"
  },
  {
    id: "topic1-check-3",
    label: "Вмію формулювати дослідницьке питання, яке потребує аналізу"
  },
  {
    id: "topic1-check-4",
    label: "Можу визначити аналітичний фокус власного дослідження"
  },
  {
    id: "topic1-check-5",
    label: "Розумію співвідношення між об’єктом, предметом і межами дослідження"
  },
  {
    id: "topic1-check-6",
    label: "Вмію формулювати робочу гіпотезу або дослідницьке припущення"
  },
  {
    id: "topic1-check-7",
    label: "Можу визначити джерела, дані або матеріали, потрібні для подальшої перевірки гіпотези"
  }
]
  },
    ...
    theory: `Практичне заняття спрямоване на формування в аспірантів уміння працювати з науковими джерелами як з основою для побудови методологічної позиції власного дисертаційного дослідження. Основна увага приділяється пошуку й відбору джерел у наукометричних базах, визначенню критеріїв добору літератури, групуванню джерел за теоретичними підходами, методами, типами даних, об’єктами аналізу та дослідницькими обмеженнями. Аспіранти вчаться заповнювати аналітичну матрицю джерел, визначати внесок кожного джерела у власну тему, виявляти повторювані підходи та недостатньо опрацьовані аспекти проблеми. Результатом заняття є попередньо сформований корпус джерел, аналітична матриця, визначена наукова прогалина та первинне методологічне позиціонування дослідження.`,
    totalFields: 12,
    exercises: [
      {
        id: "topic2-ex1",
        ...
        tasks: [
          {
            ...
            chartAnalysis: {
              ...
              description: "Приклад візуалізації тематичних кластерів і зв’язків між ключовими поняттями дослідження. Джерело: Автор",
              questions: [
                {
                  id: "q1",
...
...`
  ...
  {
    id: "topic2-check-1",
    label: "Розумію, як наукові джерела допомагають обґрунтувати мою дослідницьку тему"
  },
  {
    id: "topic2-check-2",
    label: "Вмію шукати джерела у наукометричних базах за ключовими словами й критеріями відбору"
  },
  {
    id: "topic2-check-3",
    label: "Вмію групувати джерела за підходами, методами, об’єктами або дослідницькими проблемами"
  },
  {
    id: "topic2-check-4",
    label: "Вмію заповнювати аналітичну матрицю джерел"
  },
  {
    id: "topic2-check-5",
    label: "Можу обґрунтувати внесок кожного джерела для мого дослідження"
  },
  {
    id: "topic2-check-6",
    label: "Розумію, як на основі джерел визначити наукову прогалину"
  },
  {
    id: "topic2-check-7",
    label: "Можу визначити релевантні методи для власної теми на основі аналізу джерел"
  }
]
  },
    ...
    theory: `Практичне заняття спрямоване на формування в аспірантів уміння перетворювати ключові поняття дисертаційного дослідження на робочу систему аналізу. Основна увага приділяється переходу від загальних понять, таких як якість середовища, доступність, просторова зв’язність, ідентичність, комфорт, стійкість, функціональна змішаність або людський масштаб, до критеріїв, індикаторів, змінних, джерел даних та одиниць аналізу. Аспіранти вчаться формулювати робочі визначення понять, відрізняти критерій від індикатора, індикатор від змінної, а також визначати, які характеристики можуть бути виміряні кількісно, які потребують якісної інтерпретації, а які мають бути перевірені через поєднання різних типів даних. Результатом заняття є операційна матриця власного дисертаційного дослідження, що пов’язує поняття, критерії, індикатори, змінні, джерела даних, одиниці аналізу та методи.`,
    totalFields: 12,
    exercises: [
      {
        id: "topic3-ex1",
...
...`
  ...
  {
    id: "topic3-check-1",
    label: "Розумію, навіщо ключові поняття дослідження потрібно операціоналізувати"
  },
  {
    id: "topic3-check-2",
    label: "Вмію формулювати робочі визначення основних понять моєї теми"
  },
  {
    id: "topic3-check-3",
    label: "Розумію співвідношення між поняттям, критерієм, індикатором і змінною"
  },
  {
    id: "topic3-check-4",
    label: "Вмію переводити поняття у систему критеріїв та індикаторів"
  },
  {
    id: "topic3-check-5",
    label: "Можу визначити, які дані потрібні для аналізу обраних індикаторів"
  },
  {
    id: "topic3-check-6",
    label: "Можу обрати одиниці аналізу відповідно до масштабу дослідження"
  },
  {
    id: "topic3-check-7",
    label: "Вмію будувати операційну матрицю для подальшого аналізу або моделювання"
  }
]
  },
    ...
    theory: `Практичне заняття спрямоване на формування в аспірантів уміння опрацьовувати відкриті табличні та просторові дані для аналізу архітектурно-містобудівних об’єктів. Основна увага приділяється переходу від сформованої у попередній темі системи індикаторів до роботи з реальними або умовними наборами даних: таблицями, координатами, просторовими точками, кількісними показниками, картами, схемами та діаграмами. Аспіранти вчаться виконувати базову описову статистику, аналізувати просторове розміщення об’єктів, оцінювати доступність, виявляти концентрації, відмінності між територіями, аномальні значення та попередні закономірності. Результатом заняття є первинний кількісно-просторовий аналіз обраного архітектурно-містобудівного об’єкта з таблицею даних, базовими статистичними показниками, картою або схемою, діаграмою та короткою інтерпретацією результатів.`,
    totalFields: 10,
    exercises: [
      {
        id: "topic4-ex1",
        ...
        tasks: [
          {
            ...
            chartAnalysis: {
              ...
              description: "Приклад карти для аналізу просторової нерівномірності забезпечення міських територій освітньою інфраструктурою. Джерело: https://lun.ua/misto/shkola",
              questions: [
                {
                  id: "q1",
...
...`
  ...
  {
    id: "topic4-check-1",
    label: "Розумію, які дані потрібні для кількісного або просторового аналізу моєї теми"
  },
  {
    id: "topic4-check-2",
    label: "Вмію готувати таблицю даних для аналізу архітектурно-містобудівного об’єкта"
  },
  {
    id: "topic4-check-3",
    label: "Вмію виконувати базову описову статистику для обраних показників"
  },
  {
    id: "topic4-check-4",
    label: "Можу пов’язати кількісні показники з просторовим контекстом"
  },
  {
    id: "topic4-check-5",
    label: "Вмію представляти результати через карту, схему або діаграму"
  },
  {
    id: "topic4-check-6",
    label: "Можу пояснити, які висновки справді підтверджуються даними"
  },
  {
    id: "topic4-check-7",
    label: "Розумію обмеження використаних даних, карти або діаграми"
  }
]
  },
    ...
    theory: `Практичне заняття спрямоване на формування в аспірантів уміння застосовувати якісні та змішані методи для аналізу міського середовища, громадських просторів, архітектурно-містобудівних об’єктів і користувацького досвіду. Основна увага приділяється тим аспектам дослідження, які не можуть бути повністю пояснені через кількісні показники, карти або діаграми: поведінка користувачів, просторові практики, маршрути, місця зупинки, конфлікти використання, оцінки комфорту, безпеки, доступності, ідентичності та сприйняття середовища. Аспіранти вчаться планувати спостереження, картування поведінки, інтерв’ю, аналіз користувацького досвіду й аналіз документів, а також визначати, як якісні дані можуть доповнювати кількісний і просторовий аналіз. Результатом заняття є первинна схема якісного або змішаного дослідження: обрані методи, одиниці спостереження, категорії фіксації, питання для інтерв’ю, джерела документів, спосіб інтеграції даних і очікуваний аналітичний результат.`,
    totalFields: 12,
    exercises: [
      {
        id: "topic5-ex1",
...
...`
  ...
  {
    id: "topic5-check-1",
    label: "Розумію, коли для моєї теми потрібні якісні або змішані методи"
  },
  {
    id: "topic5-check-2",
    label: "Можу визначати, який аспект міського середовища потребує якісного пояснення"
  },
  {
    id: "topic5-check-3",
    label: "Вмію планувати спостереження за поведінкою користувачів у просторі"
  },
  {
    id: "topic5-check-4",
    label: "Вмію добирати категорії для картування поведінки або користувацького досвіду"
  },
  {
    id: "topic5-check-5",
    label: "Вмію формулювати питання для інтерв’ю або короткого опитування"
  },
  {
    id: "topic5-check-6",
    label: "Можу визначати документи або польові матеріали, потрібні для якісного аналізу"
  },
  {
    id: "topic5-check-7",
    label: "Розумію, як поєднувати якісні дані з кількісними або просторовими результатами"
  }
]
  },
    ...
    theory: `Практичне заняття спрямоване на формування в аспірантів уміння будувати модель дисертаційного дослідження як цілісну аналітичну конструкцію, що пояснює зв’язок між проблемою, гіпотезою, поняттями, даними, методами та очікуваним науковим результатом. Основна увага приділяється вибору типу моделі — концептуальної, просторово-аналітичної, параметричної, алгоритмічної або комбінованої — відповідно до дослідницького питання, аналітичного фокусу, типу даних і характеру очікуваних результатів. Аспіранти вчаться визначати структуру моделі, її основні блоки, вхідні дані, ключові припущення, логіку роботи, способи перевірки та обмеження. Результатом заняття є підсумкова рамка моделі дисертаційного дослідження, яка може бути використана як основа для графічної схеми, методологічного розділу або презентації аналітичної моделі.`,
    totalFields: 12,
    exercises: [
      {
        id: "topic6-ex1",
...
...`
      ...
      {
        id: "topic6-ex4",
        title: "Блок 4. Логіка роботи моделі та зв’язки між елементами",
        tasks: [
          {
...
...`
  ...
  {
    id: "topic6-check-1",
    label: "Розумію, яку функцію має модель у моєму дисертаційному дослідженні"
  },
  {
    id: "topic6-check-2",
    label: "Можу визначити тип моделі, який відповідає моїй темі, даним і очікуваному результату"
  },
  {
    id: "topic6-check-3",
    label: "Вмію описувати основні блоки моделі та зв’язки між ними"
  },
  {
    id: "topic6-check-4",
    label: "Можу визначити вхідні дані, параметри або показники для моделі"
  },
  {
    id: "topic6-check-5",
    label: "Розумію, які припущення лежать в основі моєї моделі"
  },
  {
    id: "topic6-check-6",
    label: "Можу пояснити, який науковий результат має дати модель"
  },
  {
    id: "topic6-check-7",
    label: "Можу визначити способи перевірки та обмеження моделі"
  }
]
  },
    ...
    theory: `Практичне заняття спрямоване на підсумкове представлення та критичне обговорення аналітичної моделі дисертаційного дослідження. Основна увага приділяється демонстрації цілісної доказової логіки: яка наукова проблема досліджується, яку прогалину виявлено, яке дослідницьке питання поставлено, яка гіпотеза перевіряється, які джерела, дані й методи використано, яку модель побудовано, які результати отримано, як вони інтерпретуються і які обмеження має дослідження. Аспіранти вчаться структурувати коротку наукову презентацію, добирати карти, діаграми, схеми та інші візуальні матеріали як докази, аргументувати вибір методів і відповідати на критичні запитання щодо надійності даних, логіки моделі, перевірки гіпотези та меж висновків. Результатом заняття є представлена й обговорена аналітична модель дисертації, набір уточнень до неї та фінальна рамка подальшого доопрацювання дослідження.`,
    totalFields: 12,
    exercises: [
      {
        id: "topic7-ex1",
        ...
        tasks: [
          {
            ...
            chartAnalysis: {
              ...
              description: "Приклад структурної схеми аналітичної моделі дослідження: від постановки проблеми, огляду літератури й формулювання гіпотези до збору даних, аналізу, побудови моделі, валідації результатів і висновків. Джерело: Автор",
              questions: [
                {
                  id: "q1",
...
...`
  ...
  {
    id: "topic7-check-1",
    label: "Вмію презентувати аналітичну модель свого дослідження як послідовну доказову логіку"
  },
  {
    id: "topic7-check-2",
    label: "Можу пояснити зв’язок між проблемою, гіпотезою, даними, методами й результатами"
  },
  {
    id: "topic7-check-3",
    label: "Можу обґрунтувати вибір методів і джерел даних для своєї моделі"
  },
  {
    id: "topic7-check-4",
    label: "Вмію використовувати карти, діаграми, схеми або таблиці як візуальні докази"
  },
  {
    id: "topic7-check-5",
    label: "Вмію інтерпретувати результати без надмірного узагальнення"
  },
  {
    id: "topic7-check-6",
    label: "Розумію обмеження своєї моделі, даних і висновків"
  },
  {
    id: "topic7-check-7",
    label: "Можу відповідати на критичні запитання і визначати, що потрібно доопрацювати"
  }
]
  }
]; function T5() {
                      ...
                      S.jsxs("div", {
                        ...
                        children: [
                          S.jsxs("p", {
                            ...
                            children: [
                              "Інтерактивний робочий зошит розроблено для аспірантів спеціальності",
                              S.jsx("strong", {
                                children: " G17 «Архітектура та містобудування»"
                              }),
                              " у межах дисципліни ОК2.2 «Аналітичні методи дослідження та теоретичні моделі в архітектурі та містобудуванні». Зошит допомагає послідовно пройти основні етапи підготовки аналітичної моделі дисертаційного дослідження: від формулювання проблеми до побудови, перевірки й презентації моделі."
                            ]
                          }),
                                ...
                                children: [
                                  S.jsxs("li", {
                                    ...
                                    children: [
                                      ...
                                      S.jsx("strong", {
                                        children: "Постановка дослідження: формулювання проблеми, дослідницького питання, об’єкта, предмета, гіпотези, завдань і доказової бази"
                                      }),
                                  ...
                                  S.jsxs("li", {
                                    ...
                                    children: [
                                      ...
                                      S.jsx("strong", {
                                        children: "Джерела і методологічне позиціонування: робота з наукометричними базами, групування джерел, аналітична матриця, наукова прогалина і релевантні методи"
                                      }),
                                  ...
                                  S.jsxs("li", {
                                    ...
                                    children: [
                                      ...
                                      S.jsx("strong", {
                                        children: "Операціоналізація понять: формування критеріїв, індикаторів, змінних, джерел даних та одиниць аналізу"
                                      }),
                                    ]
                                  }),
                                  ...
                                  S.jsxs("li", {
                                    ...
                                    children: [
                                      ...
                                      S.jsx("strong", {
                                        children: "Кількісний і просторовий аналіз: CSV-дані, описова статистика, просторові точки, аналіз доступності, карти й діаграми"
                                      }),
                                    ]
                                  }),
                                  ...
                                  S.jsxs("li", {
                                    ...
                                    children: [
                                      ...
                                      S.jsx("strong", {
                                        children: "Якісні та змішані методи: спостереження, картування поведінки, інтерв’ю, аналіз користувацького досвіду, аналіз документів та інтеграція даних"
                                      }),
                                    ]
                                  }),
                                  ...
                                  S.jsxs("li", {
                                    ...
                                    children: [
                                      ...
                                      S.jsx("strong", {
                                        children: "Модель дослідження: побудова концептуальної, просторово-аналітичної або параметричної моделі, визначення вхідних даних, припущень, перевірки та обмежень"
                                      }),
                                    ]
                                  }),
                                  ...
                                  S.jsxs("li", {
                                    ...
                                    children: [
                                      ...
                                      S.jsx("strong", {
                                        children: "Презентація і критичне обговорення: підготовка структури захисту, аргументів, візуальних доказів, відповідей на критичні запитання і фінального підсумку моделі"
                                      }),
                                    ]
                                  })
                                ]
...
(function () {
  ...
  const meta = {
    ...
    copyright:
      "© 2026 Національний університет «Львівська політехніка» / Автор: О.Юрчишин"
  };
  ...
  function patchFooter() {
    ...
    footer.innerHTML = `
      <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div style="display:grid;grid-template-columns:1fr 1fr auto;gap:20px;align-items:end;width:100%;">
          <div>
          ...
          <div style="justify-self:end;text-align:right;max-width:720px;">
